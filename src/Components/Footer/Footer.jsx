      ...
      <div className="footer-content">
          <div className="footer-column">
            ...
            <p className="address-link">
              ...
              >
                <span className="line">#68 Sampaloc Extension, North Signal Village,Taguig City, Metro Manila, 1630 Philippines</span>
          ...
          <div className="footer-column contact-center">
            <div className="contact-inner">
              ...
              <div className="contact-values phone-numbers">
                <a href="tel:09177048003">09177048003</a>
                <a href="tel:09237179739 ">09237179739</a>
              </div>
            </div>
            </div>
          </div>
            ...
            <div className="social-row">
             <a href="https://www.facebook.com/recuencogenhospital" target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faFacebookF} className="social-icon"/>
                <span className="social-text">Recuenco General Hospital Inc.</span>
              </a>
            </div>
            <div className="social-row">
