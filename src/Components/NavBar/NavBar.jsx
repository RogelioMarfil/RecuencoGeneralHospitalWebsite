...
import "./NavBar.css";
import logo from "../../assets/Nav_Logo/Logo.png"
import HeadLogo from "../../assets/Nav_Header/Logo_Header.png"
    ...
    <>
      <nav className={`navbar ${scrolled ? "scrolled" : ""}`}>
        ...
        <ul className="nav-links">
          ...
          <li><Link to="/newsupdate">Events & Activities</Link></li>
          ...
          <li><Link to="/newsupdate" onClick={() => setMenuOpen(false)}>Events & Activities</Link></li>
